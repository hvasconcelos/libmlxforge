// XLLM-024: server config parsing + bounded waiting queue (no GPU).
...
TEST_CASE("XLLM-024: ServerConfig parses flags with defaults") {
...
TEST_CASE("XLLM-024: ServerConfig rejects unknown flags") {
...
TEST_CASE("XLLM-024: bounded waiting queue rejects on overflow (429)") {
  Scheduler sched;
